 ...
 */
public class JXPanel_bugfixed extends JPanel implements Scrollable {
     ...
     */
    public JXPanel_bugfixed() {
    }

    /**
     * @param isDoubleBuffered
     */
    public JXPanel_bugfixed(boolean isDoubleBuffered) {
     ...
     * @param layout
     */
    public JXPanel_bugfixed(LayoutManager layout) {
        super(layout);
    }
     ...
     * @param isDoubleBuffered
     */
    public JXPanel_bugfixed(LayoutManager layout, boolean isDoubleBuffered) {
