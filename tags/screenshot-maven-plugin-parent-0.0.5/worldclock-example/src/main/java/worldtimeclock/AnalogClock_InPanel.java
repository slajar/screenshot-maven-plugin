 ...
 * @author hansolo
 */
public class AnalogClock_InPanel extends javax.swing.JComponent implements java.awt.event.ActionListener
{
    ...
    public void actionPerformed(java.awt.event.ActionEvent event)
    {
        ...
        {   
            ...
            if (autoType)
            {                
                if (java.util.Calendar.getInstance().get(java.util.Calendar.HOUR_OF_DAY) - this.timeZoneOffsetHour >= 18 || java.util.Calendar.getInstance().get(java.util.Calendar.HOUR_OF_DAY) - timeZoneOffsetHour < 6)
                {
                    setType(type.DARK);
                }
                else
